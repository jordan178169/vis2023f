...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>這份問卷中受訪者工作地點的所在區域在北部占了超過半數。</li>
    <li>大部分的受訪者認為藝術跟台灣 2050 淨零排放政策的相關度不是那麼高。</li>
  </ul>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["5","4","3","2","1","北部", "中部", "南部", "東部"])
  //.range(d3.schemePaired)
  .range(["#1f77b4","#ff7f0e","#2ca02c","#DC9FB4","#9467bd","#8c564b", "#C2FF68", "#46A3FF", "#FF2D2D"])
  .unknown("#BEBEBE")
)}
